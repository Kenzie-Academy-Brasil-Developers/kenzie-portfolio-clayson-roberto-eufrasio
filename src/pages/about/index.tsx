          ...
          <ProjectAreaWrapperColumns>
            <ProjectsAreaSocialMediaMessageAbout>
              <Text className="aboutMe" as="p" type="body1" color="grey2">
                ...
                emprego onde eu possa não apenas estar ali mas contribuir sem
                deixar de evoluir com o crescimento num todo. Hoje não sou o
                mesmo de dois anos atraz minha bagagem na área de programação
                está cada dia aumentando mais e mais, com isso gostaria muito de
                poder mostrar o que venho aprendendo nesses últimos tempos e o
                quanto estou disposto a aprender coisas novas.
              </Text>
            </ProjectsAreaSocialMediaMessageAbout>
          </ProjectAreaWrapperColumns>
        </Container>
